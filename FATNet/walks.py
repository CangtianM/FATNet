...
class Graph(object):
    ...
    def read_node_status(self):
        ...
        for line in lines:
            line = line.split(' ')
            self.G.nodes[line[0]]['status'] = line[1] 
...
if __name__=='__main__':
    ...
    dataname = 'blogcatalog'
    
    graph_config = {
        'is_adjlist': False,
        'graph_file': './data/'+dataname+'/edges.txt',
        'label_file': './data/'+dataname+'/group.txt',
        'feature_file': './data/'+dataname+'/features.txt',
        'node_status_file': '',
    }
    ...
    walk_config = {
        ...
        'walk_length': 10,
        'window_size': 5,
        'walks_file': './data/'+dataname+'/walks_10105.txt'
    }
